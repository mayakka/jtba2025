...
$args =  array(
  ...
  'post_type'        => 'kantou', //投稿タイプ名postは通常の投稿
...
<section class="entrylist-container">
  <div class="wrapper-houwa-title">
    <h4><a href="<?php echo get_permalink(); ?>"><span><?php echo get_post_meta($post->ID,'kantou_number',true); ?>.</span><?php the_title(); ?></a></h4>
    <p><a href="<?php echo get_permalink(); ?>" class="a-black"><?php echo get_post_meta($post->ID,'kantou_subtitle',true); ?></a></p>
  </div>

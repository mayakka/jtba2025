<nav class="nav-single-bottom nav-for-medium show-for-medium">
  ...
  <div class="navpart-single-center"><a href="<?php echo esc_url( home_url( '/dhamma/tobira/' ) ); ?>">智慧の扉INDEX</a></div>
...
<nav class="nav-single-bottom nav-for-small show-for-small-only">
  ...
  <a href="<?php echo esc_url( home_url( '/dhamma/tobira/' ) ); ?>" class="navpart-single-center">一覧</a>

<nav class="nav-single-bottom nav-for-medium show-for-medium">
  ...
  <div class="navpart-single-center"><a href="<?php echo esc_url( home_url( '/dhamma/kantou/' ) ); ?>">巻頭法話INDEX</a></div>
...
<nav class="nav-single-bottom nav-for-small show-for-small-only">
  ...
  <a href="<?php echo esc_url( home_url( '/dhamma/kantou/' ) ); ?>" class="navpart-single-center">一覧</a>
